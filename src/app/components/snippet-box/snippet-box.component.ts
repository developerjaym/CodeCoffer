...
export class SnippetBoxComponent implements OnInit, OnDestroy {
  ...
  constructor(private copyService: CopyService, private snippetService: SnippetService, 
    private undoService: UndoService, private toastService: ToastService, private router: Router) {
      this.subscriptions = [];
  }
